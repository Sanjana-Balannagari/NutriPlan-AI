...
GROUND_TRUTH_MEALS = {
    (('vegan',), 1800): [
        {"id": "987654", "type": "Breakfast", "name": "Tofu Quinoa Salad", "calories": 540, "tags": ["vegan", "high_protein"]},
        {"id": "319874", "type": "Lunch", "name": "Hummus, Sabra Classic", "calories": 720, "tags": ["vegan", "healthy", "lunch"]},
        {"id": "1234567", "type": "Dinner", "name": "Healthy Choice Vegan Bowl", "calories": 540, "tags": ["vegan", "healthy"]}
    ],
    (('low_carb', 'high_protein'), 2200): [
        {"id": "778899", "type": "Breakfast", "name": "Egg White Omelette", "calories": 660, "tags": ["low_carb", "high_protein"]},
        {"id": "445566", "type": "Lunch", "name": "Salmon Avocado Bowl", "calories": 880, "tags": ["low_carb", "high_protein"]},
        {"id": "112233", "type": "Dinner", "name": "Grilled Chicken Breast", "calories": 880, "tags": ["low_carb", "high_protein"]}
    ],
    ((), 1500): [
        {"id": "223344", "type": "Breakfast", "name": "Greek Yogurt Bowl", "calories": 450, "tags": ["healthy"]},
        {"id": "556677", "type": "Lunch", "name": "Turkey Sandwich", "calories": 600, "tags": ["healthy"]},
        {"id": "889900", "type": "Dinner", "name": "Veggie Stir Fry", "calories": 450, "tags": ["healthy"]}
    ]
}
...
def get_meal_plan(prefs, total_calories, k=5):
    ...
    # === NORMAL LOGIC BELOW (for real users) ===
    targets = [
    ...
    for meal_type, target_cal in targets:
        ...
        if selected is not None:
            ...
            meals.append({'id': 'N/A', 'type': meal_type, 'name': "No option", 'calories': 0, 'tags': []})
