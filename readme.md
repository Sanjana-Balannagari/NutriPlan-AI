...
2. Download:
   - `FoodData_Central_csv_2024-10-24.zip`
3. Extract and place in `data/raw/`:
data/raw/food.csv
...
│
├── utils/
│   └── pdf_generator.py         # Export plan to PDF
│
├── static/
...
│
├── scripts/
│   ├── generate_meals.py        # Step 1: Build meals.csv
...
| `OpenAIError` | No key needed – fallback parser used | Connected OpenAI key - Advanced Parsing
